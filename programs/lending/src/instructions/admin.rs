...
pub struct InitBank<'info>{
    ...
    // Bank account to store the state of the bank
    #[account(
        init, 
        payer = signer, 
    ...
    // Bank token account to hold the tokens
    #[account(
        init,
        token::mint = mint,
...
// Process the initialization of the bank
...
// Process the initialization of the user
